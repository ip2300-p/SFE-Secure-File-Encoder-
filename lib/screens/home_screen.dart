    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(savedPath != null
            ? '${AppStrings.t('saved_prefix')}$savedPath'
            : AppStrings.t('cancelled_text')),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          needsManual == 0
              ? '$savedDirect ✓'
              : '$savedDirect ✓ / $needsManual ${AppStrings.t('save_tooltip')}',
        ),
                  ...
                  return SizedBox(
                    ...
                    child: FilledButton.icon(
                      style: FilledButton.styleFrom(
                        backgroundColor: isEncryptTab ? theme.colorScheme.primary : theme.colorScheme.tertiary,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      ),
                      onPressed: _busy
                          ? null
